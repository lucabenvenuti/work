...
#PBS -N LShCeMasDE4000RS387
#PBS -o ${PBS_JOBID}__outShearCellMasterDE4000RS387__${PBS_JOBID}.out
#PBS -j oe
#PBS -l nodes=4:ppn=8
...
VARS="-var iden 50081 -var NTHREADS $NTHREADS -var XPROCS $XPROCS -var YPROCS $YPROCS -var ZPROCS $ZPROCS -var OMPON $OMPON -var DCYLDP $DCYLDP"
