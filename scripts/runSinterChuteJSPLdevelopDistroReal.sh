...
#PBS -N LIGSintdevelopDistroReal
#PBS -o ${PBS_JOBID}__outSinterChuteJSPLdevelopDistroReal__${PBS_JOBID}.out
#PBS -j oe
#PBS -l nodes=8:ppn=8
...
cd ../sinterChuteJSPLdevelopDistroReal

OMPON=2   # develop = 2 
DCYLDP=5

echo developDistroReal mode on
NTHREADS=1
XPROCS=4
YPROCS=4
ZPROCS=4
