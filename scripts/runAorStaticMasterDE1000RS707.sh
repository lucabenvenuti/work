...
#PBS -N LAoStMasDE1000RS707
#PBS -o ${PBS_JOBID}__outAorStaticMasterDE1000RS707__${PBS_JOBID}.out
#PBS -j oe
#PBS -l nodes=4:ppn=8
...
VARS="-var iden 2061 -var NTHREADS $NTHREADS -var XPROCS $XPROCS -var YPROCS $YPROCS -var ZPROCS $ZPROCS -var OMPON $OMPON -var DCYLDP $DCYLDP"
