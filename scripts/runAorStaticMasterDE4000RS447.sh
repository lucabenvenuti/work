...
#PBS -N LAoStMasDE4000RS447
#PBS -o ${PBS_JOBID}__outAorStaticMasterDE4000RS447__${PBS_JOBID}.out
#PBS -j oe
#PBS -l nodes=4:ppn=8
...
VARS="-var iden 2101 -var NTHREADS $NTHREADS -var XPROCS $XPROCS -var YPROCS $YPROCS -var ZPROCS $ZPROCS -var OMPON $OMPON -var DCYLDP $DCYLDP"
