...
#PBS -N LAoStMasDE1000RS570
#PBS -o ${PBS_JOBID}__outAorStaticMasterDE1000RS570__${PBS_JOBID}.out
#PBS -j oe
#PBS -l nodes=4:ppn=8
...
VARS="-var iden 2041 -var NTHREADS $NTHREADS -var XPROCS $XPROCS -var YPROCS $YPROCS -var ZPROCS $ZPROCS -var OMPON $OMPON -var DCYLDP $DCYLDP"
