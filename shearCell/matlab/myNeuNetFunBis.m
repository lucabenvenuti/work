function [NNSave, errorNN, x, zz, errorEstSum, errorEstIndex, errorEstSumMaxIndex, yyy, corrMatPca,z,yy] =   myNeuNetFunBis(nSimCases2,data2,trainFcn2,hiddenLayerSizeVector2, target1, target2, target3)
